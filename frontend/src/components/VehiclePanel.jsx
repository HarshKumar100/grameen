        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>GrameenCar 
                        {/* <span><i className="ri-user-3-fill"></i>4</span> */}
                        </h4>
                    <h5 className='font-medium text-sm'>2 mins away </h5>
                    <p className='font-normal text-xs text-gray-600'>Delivery in 10 min</p>
                </div>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>GrameenMoto 
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    <h4 className='font-medium text-base'>GrameenAuto 
